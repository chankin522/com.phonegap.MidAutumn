// Initialize app
var url = 'https://retehk.com/peninsula/getMidContent/index.php';
var url2 = 'https://retehk.com/peninsula/getMidContent/update.php';
var url3 = 'https://retehk.com/peninsula/getMidContent/form_qt1.php';
var url4 = 'https://retehk.com/peninsula/getMidContent/form_qt2.php';
var wrong=0;
var session='';
var type='';
...
function changeStock(){
 $$(".btn-gift").click(function(){
    ...
    $$.ajax({
      type: 'GET',
      url: url2+'?id='+id+'&name='+name+'&session='+session+'&type='+type+'&staging='+staging,
      contentType: "OPTIONS", 
      dataType: 'text',
      crossDomain: true,
      error: function(e) {
...
function formSubmit(){
  ...
  //var date=JSON.stringify(formData);
	 ...
	 $$('.form-control,.tnc').removeClass('err');
	  ...
	  if(type=='1'){
		  var $data = 'name='+name+'&email='+email+'&tel='+tel+'&gender='+gender+'&day='+day+'&month='+month+'&tnc='+tnc+'&isemail='+isEmail+'&issns='+isSns+'&type='+type+'&staging='+staging;
		  ...
		  var $data = 'name='+name+'&email='+email+'&tel='+tel+'&gender='+gender+'&day='+day+'&month='+month+'&tnc='+tnc+'&isemail='+isEmail+'&issns='+isSns+'&type='+type+'&qt1='+qt1+'&qt2='+qt2+'&qt3='+qt3+'&qt4='+qt4+'&qt5='+qt5+'&staging='+staging;
		  var $url =url4;
	  }
...
$$(document).on('pageInit', '.page[data-page="q1"]', function (e) {
	//initQuestionSelect();
    ...
    success: function( response ) {  
      ...
      for(x=0;x<response.gift.length; x++){
        ...
        if(response.gift[x].stock<=0){
          html+='<div><img src="images/gift/gift'+response.gift[x].id+'_sold.jpg" width="100%" ></div>';
        } else {
...
var i=0;
i++;
gifttext[i]='10% off upon any purchase<br/><span class="t-tc">享有九折購物優惠</span>';
i++;
gifttext[i]='<span style="letter-spacing: -0.5px;">Special offer of HK$ 800 for 1 HK$ 1,900 hamper</span><br/><span class="t-tc">以優惠價800港元購買價值1,900港元之禮物籃</span>';
i++;
gifttext[i]='Enjoy 15% off on XO Chilli Sauce<br/><span class="t-tc">以八五折優惠購買XO辣椒醬</span>';
i++;
gifttext[i]='Enjoy 15% off on Peninsula Tea Collection<br/><span class="t-tc">以八五折優惠購買半島名茶系列</span>';
i++;

gifttext[i]='<span style="letter-spacing:-0.7px;">Enjoy 10% off on Appreciation Chocolates – 12/24 Pieces</span><br/><span class="t-tc">以九折優惠購買珍嚐系列 - 手工朱古力禮盒 - 12或24粒</span>';
i++;
